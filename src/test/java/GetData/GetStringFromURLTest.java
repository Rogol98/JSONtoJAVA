...
import static GetData.GetStringFromURL.readJsonFromUrl;
import static org.junit.jupiter.api.Assertions.assertEquals;
import org.junit.Test;
import java.io.*;
import static GetData.GetStringFromURL.readAll;

public class GetStringFromURLTest {
    ...
    public void readJsonFromUrlTest() throws IOException {
        String result = readJsonFromUrl("https://jsonplaceholder.typicode.com/posts");
        //<editor-fold desc="String expected
        // ">
        String expected = "[\n" +
               "  {\n" +
               "    \"userId\": 1,\n" +
